...
if os.path.isfile(f"{model_path}/latent_diffusion_txt2img_f8_large.ckpt"):
    print("Using saved model from local Drive")
else:    
    os.system(f'wget -O {model_path}/latent_diffusion_txt2img_f8_large.ckpt https://ommer-lab.com/files/latent-diffusion/nitro/txt2img-f8-large/model.ckpt')
...
args = argparse.Namespace( # this is opt in function "run"
    prompt = Prompt, 
